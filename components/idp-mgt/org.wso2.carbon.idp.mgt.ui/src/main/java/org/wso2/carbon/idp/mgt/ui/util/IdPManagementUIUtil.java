...
public class IdPManagementUIUtil {
    ...
    private static void buildOpenIDConnectAuthenticationConfiguration(IdentityProvider fedIdp,
        ...
        if (paramMap.get(IdentityApplicationConstants.Authenticator.OIDC.USE_OIDC_CLAIM_DIALECT) != null) {
            property.setValue(paramMap.get(IdentityApplicationConstants.Authenticator.OIDC.USE_OIDC_CLAIM_DIALECT));
        }
