        ...
        <tr>
            ...
            <td>
                <div id="showHideButtonDivIdOauth" style="border:1px solid rgb(88, 105, 125);" class="leftCol-med">
                    <input id="clientSecret" name="clientSecret" type="password" autocomplete="false"
        ...
        <tr>
            ...
            <td>
                <div id="showHideButtonDivId" style="border:1px solid rgb(88, 105, 125);" class="leftCol-med">
                    <input id="fbClientSecret" name="fbClientSecret" type="password" autocomplete="false"
    ...
    <table class="carbonFormTable">
        ...
        <tr>
            ...
            <td><input class="text-box-big" id="scim-password"
                       name="scim-password" type="password" autocomplete="false" value=<%=Encode.forHtmlAttribute(scimPassword) %>></td>
        </tr>
        <tr>
            <td class="leftCol-med labelField"><fmt:message
