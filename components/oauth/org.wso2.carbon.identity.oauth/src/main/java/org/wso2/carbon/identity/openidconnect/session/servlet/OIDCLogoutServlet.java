/*
 * Copyright (c) $date.year, WSO2 Inc. (http://www.wso2.org) All Rights Reserved.
 *
...
import org.wso2.carbon.identity.openidconnect.session.cache.OIDCSessionDataCache;
import org.wso2.carbon.identity.openidconnect.session.cache.OIDCSessionDataCacheEntry;
import org.wso2.carbon.identity.openidconnect.session.cache.OIDCSessionDataCacheKey;
...
public class OIDCLogoutServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (StringUtils.isNotBlank(consent)) {
            ...
            boolean skipConsent = getOpenIDConnectSkipUserConsent();
            if (skipConsent) {
     ...
     * @return
     */
    private static boolean getOpenIDConnectSkipUserConsent() {
