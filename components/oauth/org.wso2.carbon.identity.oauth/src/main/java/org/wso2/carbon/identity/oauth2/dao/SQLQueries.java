...
public class SQLQueries {
    ...
    public static final String STORE_AUTHORIZATION_CODE_WITH_HASH = "INSERT INTO  IDN_OAUTH2_AUTHORIZATION_CODE "
            + "(CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE, AUTHZ_USER, USER_DOMAIN, TENANT_ID, "
    ...
    public static final String STORE_AUTHORIZATION_CODE_WITH_PKCE_WITH_HASH =
            "INSERT INTO  " + "IDN_OAUTH2_AUTHORIZATION_CODE "
                    + "(CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE, AUTHZ_USER, USER_DOMAIN, TENANT_ID, "
                    + "TIME_CREATED, VALIDITY_PERIOD, SUBJECT_IDENTIFIER, PKCE_CODE_CHALLENGE, PKCE_CODE_CHALLENGE_METHOD, AUTHORIZATION_CODE_HASH) "
    ...
    public static final String VALIDATE_AUTHZ_CODE_WITH_HASH = "SELECT AUTHZ_USER, USER_DOMAIN, TENANT_ID, SCOPE, "
            ...
            + "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND "
    ...
    public static final String VALIDATE_AUTHZ_CODE_WITH_PKCE_WITH_HASH =
            "SELECT AUTHZ_USER, USER_DOMAIN, TENANT_ID, " + "SCOPE, "
                    + "CALLBACK_URL, TIME_CREATED,VALIDITY_PERIOD, STATE, TOKEN_ID, AUTHORIZATION_CODE, CODE_ID, SUBJECT_IDENTIFIER, "
                    + "PKCE_CODE_CHALLENGE, PKCE_CODE_CHALLENGE_METHOD FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE "
                    + "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND "
                    + "AUTHORIZATION_CODE_HASH = ?";
    ...
    public static final String RETRIEVE_CODE_ID_BY_AUTHORIZATION_CODE_WITH_HASH =
            "SELECT CODE_ID FROM " + "IDN_OAUTH2_AUTHORIZATION_CODE WHERE AUTHORIZATION_CODE_HASH = ?";
    ...
    public static final String RETRIEVE_TOKEN_ID_BY_TOKEN_WITH_HASH = "SELECT TOKEN_ID FROM " +
    ...
    public static final String DEACTIVATE_AUTHZ_CODE_AND_INSERT_CURRENT_TOKEN_WITH_HASH =
            "UPDATE " + "IDN_OAUTH2_AUTHORIZATION_CODE SET " + "STATE='INACTIVE', TOKEN_ID=?"
                    + " WHERE AUTHORIZATION_CODE_HASH= ?";

    public static final String CHECK_AUTHORIZATION_CODE =
            "SELECT AUTHORIZATION_CODE FROM " + "IDN_OAUTH2_AUTHORIZATION_CODE WHERE AUTHORIZATION_CODE=?";

    public static final String CHECK_REFRESH_TOKEN =
            "SELECT REFRESH_TOKEN FROM " + "IDN_OAUTH2_ACCESS_TOKEN WHERE REFRESH_TOKEN=?";

    public static final String CHECK_ACCESS_TOKEN =
            "SELECT ACCESS_TOKEN FROM " + "IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN=?";

    public static final String UPDATE_AUTHORIZATION_CODE_WITH_HASH = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE SET "
            + "AUTHORIZATION_CODE=?, AUTHORIZATION_CODE_HASH=? WHERE AUTHORIZATION_CODE=?";

    public static final String UPDATE_ACCESS_TOKEN_WITH_HASH =
            "UPDATE IDN_OAUTH2_ACCESS_TOKEN " + "SET ACCESS_TOKEN=?, ACCESS_TOKEN_HASH=? WHERE ACCESS_TOKEN=?";

    public static final String UPDATE_REFRESH_TOKEN_WITH_HASH =
            "UPDATE IDN_OAUTH2_ACCESS_TOKEN " + "SET REFRESH_TOKEN=?,REFRESH_TOKEN_HASH=? WHERE REFRESH_TOKEN=?";
...
//            "TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? ORDER BY TIME_CREATED DESC";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_MSSQL = "SELECT TOP 1 " +
            ...
            "IDN_OAUTH2_ACCESS_TOKEN WITH (NOLOCK) WHERE " +
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER=? AND " +
            "TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? ORDER BY TIME_CREATED DESC";
    ...
    public static final String GET_ACCESS_TOKEN_DATA_BY_AUTHZUSER = "SELECT DISTINCT ACCESS_TOKEN, REFRESH_TOKEN, " +
            "ACCESS_TOKEN_TABLE.TOKEN_ID, TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_TIME_CREATED, " +
            ...
            "TOKEN_STATE=? AND USER_DOMAIN=?) ACCESS_TOKEN_TABLE JOIN IDN_OAUTH_CONSUMER_APPS ON ID = CONSUMER_KEY_ID " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID " +
            "WHERE TOKEN_SCOPE=?";

    public static final String GET_AUTHORIZATION_CODE_DATA_BY_AUTHZUSER = "SELECT DISTINCT AUTHORIZATION_CODE, TIME_CREATED, " +
            "VALIDITY_PERIOD, CODE_ID, SCOPE, IDN_OAUTH2_AUTHORIZATION_CODE.CALLBACK_URL, CONSUMER_KEY FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE JOIN IDN_OAUTH_CONSUMER_APPS ON " +
            "IDN_OAUTH2_AUTHORIZATION_CODE.CONSUMER_KEY_ID=IDN_OAUTH_CONSUMER_APPS.ID WHERE AUTHZ_USER=? AND " +
            "IDN_OAUTH2_AUTHORIZATION_CODE.TENANT_ID=? AND IDN_OAUTH2_AUTHORIZATION_CODE.USER_DOMAIN=? AND " +
            "STATE=? AND SCOPE LIKE '%openid%'";
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_WITH_HASH =
            "SELECT CONSUMER_KEY, AUTHZ_USER, ACCESS_TOKEN_TABLE.TENANT_ID, "
                    ...
                    + "SUBJECT_IDENTIFIER FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN_HASH=? AND "
    ...
    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_WITH_HASH = "SELECT CONSUMER_KEY, AUTHZ_USER, "
            + "ACCESS_TOKEN_TABLE.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, "
            + "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, "
            + "GRANT_TYPE, SUBJECT_IDENTIFIER "
            + "FROM (SELECT TOKEN_ID, CONSUMER_KEY, AUTHZ_USER, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID, "
    ...
    public static final String REVOKE_ACCESS_TOKEN_WITH_HASH =
            "UPDATE IDN_OAUTH2_ACCESS_TOKEN SET TOKEN_STATE=?, " + "TOKEN_STATE_ID=? WHERE ACCESS_TOKEN_HASH=?";
    ...
    public static final String UPDATE_AUTHORIZATION_CODE_STATE_WITH_HASH =
            "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE SET " + "STATE=? " + "WHERE AUTHORIZATION_CODE_HASH=?";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_HASH_MYSQL =
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_HASH_DB2SQL = "SELECT ACCESS_TOKEN, "
            + "AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM ( " +
            "SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM $accessTokenStoreTable " +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND " +
            "REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC FETCH FIRST 1 ROWS ONLY) ACCESS_TOKEN_SELECTED LEFT "
            + "JOIN " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_ORACLE = "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM ( SELECT * FROM " +
            "(SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM $accessTokenStoreTable WHERE CONSUMER_KEY_ID = (SELECT ID " +
            "FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN = ? ORDER BY TIME_CREATED DESC) " +
            "WHERE ROWNUM < 2 )  ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON " +
            "ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_HASH_ORACLE = "SELECT ACCESS_TOKEN, "
            + "AUTHZ_USER,"
            + " " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM ( " +
            ...
            "CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ) " +
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_SELECTED.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";

    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_HASH_MSSQL = "SELECT ACCESS_TOKEN, "
            + "AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM " +
            ...
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_MSSQL = "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            ...
            + "ACCESS_TOKEN, " +
            "AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM $accessTokenStoreTable WHERE CONSUMER_KEY_ID = "
            + "(SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN = ? ORDER BY TIME_CREATED DESC) " +
            "IDN_OAUTH2_ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON IDN_OAUTH2_ACCESS_TOKEN_SELECTED" +
            ".TOKEN_ID  = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_HASH_POSTGRESQL = "SELECT ACCESS_TOKEN, "
            + "AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM " +
            "(SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_HASH_INFORMIX = "SELECT ACCESS_TOKEN, "
            + "AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM ( " +
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN_WITH_HASH = "INSERT INTO $accessTokenStoreTable "
            + "(ACCESS_TOKEN, " +
            "REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TIME_CREATED, " +
            "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, " +
    ...
    public static final String RETRIEVE_LATEST_NON_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_ORACLE = "SELECT * FROM " +
            "(SELECT ACCESS_TOKEN, REFRESH_TOKEN, TOIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID=(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY" +
